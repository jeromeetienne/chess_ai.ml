...
class MoveEncodingUci2Class:
    ...
    @staticmethod
    def decode_move_tensor_classindex(moves_tensor: torch.Tensor, color: chess.Color) -> chess.Move:
        """
...
if __name__ == "__main__":
    ...
    move_tensor = MoveEncodingUci2Class.encode_move_tensor_classindex(move, turn)
    reconstructed_move = MoveEncodingUci2Class.decode_move_tensor_classindex(move_tensor, turn)
